    ...
    <div class="wrapper">
        <div class="main_banner_content">
            ...
            <div class="main_banner_plans">
                <a href="<?php echo $custom_link ?>" target="_blank" onmouseover="preloadPage(this)">
                    <div class="plan">
        ...
        <div class="main_banner_image">
            <img class="banner_image" src="<?php echo get_theme_file_uri('/img/doctor-presenting-mobile.avif') ?>" alt="Doutor de jaleco branco sorrindo">
            <img class="banner_image_desktop" src="<?php echo get_theme_file_uri('/img/doctor-presenting-desktop.png') ?>" alt="Doutor de jaleco branco sorrindo">
        </div>
    </div>
</div>
